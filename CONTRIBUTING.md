...
Open an issue at https://github.com/joao-coimbra/failcraft/issues and include:
...
Open a [GitHub Discussion](https://github.com/joao-coimbra/failcraft/discussions) before implementing. This ensures alignment on design before effort is spent.
...
```
src/
├── index.ts          # Main entry — barrel re-exports public API
